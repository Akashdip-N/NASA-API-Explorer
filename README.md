...
│
│   │── .env                                # Example environment variables file for the frontend
...
│   ├── .env                                # Environment variables file for the backend
│   ├── .env.example                        # Example environment variables file for the backend
│   └── package.json
│
